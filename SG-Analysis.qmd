---
title: "Effective Presentation Time of a Threat: Testing perception vs. judgment in a modified replication of Abado et al. (2023)"
format:
  html:
    code-fold: true
    theme: 
...
## this downloads data from the OSF if not present in working directory.
...
knitr::include_graphics("/Users/seeker/Documents/rstudio - projects/spiderguns-may1/SG-Analysis_files/img/Figure1.jpeg")
```
...
#| results: hide
#| warning: false
#| fig-cap: Split-half reliabiliy plots split by time manipulation (left) and stimulus character (right).
...
knitr::kable(df_for_publication_2, "html") %>%
...
knitr::kable(as.data.frame(testanova[["Error: unique_identifier"]][[1]]), "html") %>%
  kableExtra::kable_styling(full_width = FALSE)

knitr::kable(as.data.frame(testanova[["Error: Within"]][[1]]), "html") %>%
  kableExtra::kable_styling(full_width = FALSE)
